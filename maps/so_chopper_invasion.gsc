...
so_init_players()
{
	level.groundplayer = level.player;

	/#
	level.player thread debug_player_radius();
	#/

	//level.chopper 		thread chopper_playermount( level.chopperplayer );
	
	//Hiding the original minigun from model.
	level.chopper hidepart( "tag_turret_base" );
	level.chopper hidepart( "tag_turret" );
	level.chopper hidepart( "turret_animate_jnt" );
	level.chopper hidepart( "tag_barrel" );
	level.chopper hidepart( "barrel_animate_jnt" );
	level.chopper hidepart( "spin_jnt" );

	level.chopper thread chopper_minigun_spawn_think();
...
chopper_driveby_trigger()
{
	...
	level.turret thread chopper_ai_minigun_think(1.25);
	wait( 2 );
...
parkinglot_trucks()
{
	...
	level.turret thread chopper_ai_minigun_think(1.5);
...
end()
{
	...
	level.turret thread chopper_ai_minigun_think(1);
...
//	temp_tag LinkTo( self );
	...
	level.turret thread chopper_ai_minigun_think(0.25);
